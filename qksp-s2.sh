...
echo ""
echo "YOU CAN NOW REMOVE THE DRIVE"
...
#Modifying System Tool Data
echo "Modifying Shellinabox Config Data..."
sudo cp "./qksp-f/shellinabox" "/etc/default/"

echo "Modifying Cockpit Config Data..."
sudo cp "./qksp-f/cockpit.conf" "/etc/cockpit/"
...
sudo wget -c https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb -O googlechrome.deb -P ./
